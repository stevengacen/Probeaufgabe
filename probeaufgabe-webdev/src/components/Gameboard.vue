...
<div class="canvas-container">
    <Transition name="slide-fade">
        <InfoSidebar v-if="selectedSquare && windowWidth >= 800" ref="infoSidebar" :square="selectedSquare" @update-square="updateSquare" />
    </Transition>
    <MobileInfo v-if="selectedSquare && windowWidth < 800" :square="selectedSquare" @update-square="updateSquare" />
    <canvas ref="canvas" class="canvas" @mousedown="startDrag" @mousemove="handleMouseMove" @mouseup="endDrag" @mouseleave="endDrag" @wheel="zoom" @click="handleCanvasClick">
    </canvas>
</div>
</template>
